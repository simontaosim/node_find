...
database_name = case Padrino.env
  when :development then 'mass_alth_development'
  when :production  then 'mass_alth_production'
  when :test        then 'mass_alth_test'
end
...
#     sessions:
#       default:
#         database: mass_alth_development
#         hosts:
#           - localhost:27017
#   production:
#     sessions:
#       default:
#         database: mass_alth_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: mass_alth_test
#         hosts:
#           - localhost:27017
#
#
